...
// Keep pillars in a fixed, meaningful order
const PILLAR_ORDER = [
...
export default function HriAssessmentPage() {
  ...
  // Group questions by pillar using the new HRI pillar labels
    ...
    >
      ...
      <section style={{ marginBottom: 20 }}>
        ...
        >
          ...
          pillars. This is your internal benchmark before you layer in live
          employee data.
        </p>
        <p
          style={{
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {submitting ? "Saving your assessment…" : "Save internal assessment"}
        </button>
      </form>
    </div>
  );
