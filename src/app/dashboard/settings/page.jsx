...
// Map internal pillar names -> nicer display labels
const DISPLAY_PILLAR_LABELS = {
  "Leadership": "Human-Centred Leadership",
  "Wellbeing & Mental Health": "Wellbeing & Mental Health",
  "Inclusion & Belonging": "Inclusion, Safety & Belonging",
  "Growth & Development": "Growth, Learning & Performance",
  "Trust & Communication": "Trust, Communication & Clarity",
};
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      for (const q of questions) {
        ...
        const pillarName = q.pillar || q.pillar_name || "Unknown pillar";
      ...
      const overallScore = count > 0 ? Math.round(sum / count) : null;
      ...
      setResult({
        overallScore: apiResult?.overallScore ?? overallScore,
        pillarScores: apiResult?.pillarScores ?? pillarScores,
        answeredCount,
        totalQuestions,
      });
    } catch (err) {
      ...
      setSubmitError(
        err?.message || "Something went wrong submitting your pulse."
      );
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 20 }}>
        ...
        >
          Quick, anonymous pulse check across the five HRI pillars. Please
          answer each question from 1–5.
        </p>
        <p
          style={{
            fontSize: 12,
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {questions.map((q) => {
            ...
            const rawPillar = q.pillar || q.pillar_name || "Pillar";
            const displayPillar =
              DISPLAY_PILLAR_LABELS[rawPillar] || rawPillar;
      ...
      {result && (
        ...
        >
          ...
          >
            ...
            pillars. On your main dashboard you’ll see this aggregated across
            all employees.
          </p>
          ...
          >
            <div>
              ...
              >
                Based on {result.answeredCount} of {result.totalQuestions}{" "}
                questions.
              </div>
            </div>
            ...
            >
              {result.pillarScores.map((p) => {
                const displayPillar =
                  DISPLAY_PILLAR_LABELS[p.pillar] || p.pillar;
